...
int main(int argc, char* argv[])
{
    ...
    std::shared_ptr<r1cs_pcd_message<FieldT> > incoming_message = new zkspv_pcd_message(1,uint256(), uint256(), timestamp);
    std::shared_ptr<r1cs_pcd_message<FieldT> > outcoming_message = new zkspv_pcd_message(1,uint256(), uint256(), timestamp);
